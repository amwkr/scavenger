...
@Log
public class PathsCodeBaseScanner implements CodeBaseScanner {
    ...
    public PathsCodeBaseScanner(Config config) {
        this.config = config;
    ...
    private List<ClassNode> scanClasses(JarInputStream jarInputStream) throws IOException {
        ...
        while ((innerEntry = jarInputStream.getNextJarEntry()) != null) {
            ...
            if (innerEntry.getName().startsWith("com.example.demo")) {
                innerEntry = innerEntry;
            }
