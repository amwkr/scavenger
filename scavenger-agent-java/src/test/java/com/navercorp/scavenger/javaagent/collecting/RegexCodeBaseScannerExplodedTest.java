...
@Nested
@DisplayName("RegexCodeBaseScanner class")
public class RegexCodeBaseScannerExplodedTest {
    Config config;
    ...
    public void setUp() throws IOException, InterruptedException {
        ...
        props.setProperty("regexMode", "true");
    ...
    class ScanMethodTest {
        ...
        class FilterExcludedPackagesTest {
            ...
            public void setExcludedPackages() {
                config.setExcludePackageRegex("com\\.example\\.demo\\.additional.*");
                scanner = new RegexCodeBaseScanner(config);
            }
        ...
        class FilterAnnotationTest {
            ...
            class FilterAdditionalPackageTest {
                ...
                public void setFilters() {
                    config.setAnnotations(Collections.singletonList("org.springframework.web.bind.annotation.RestController"));
                    config.setAdditionalPackageRegex("com\\.example\\.demo\\.additional.*");
                    scanner = new RegexCodeBaseScanner(config);
                }
